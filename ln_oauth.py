...
def auth(credentials):
    ...
    if 'access_token' not in creds.keys(): 
        ...
        access_token = creds['access_token']    # access_token will be generated and aaded to credentials.json
    return access_token
...
def authorize(api_url,client_id,client_secret,redirect_uri):
    ...
    redirect_response = input('Paste the full redirect URL here:')  # Paste the redirect URl of error pagge 
